...
public class MovimientosPJ6 extends Thread {
    ...
    public MovimientosPJ6(JLabel FigFicha, JLabel SigTurno, JButton botongirar, JLabel nombreTurno) {
    ...
    public void run() {
        ...
        if (cantidad > 0) {
            ...
            if (restantetotal<=0){
         JOptionPane.showMessageDialog(null ,"ha perdido el jugador 6 " );
         }else{}
        }
    }
