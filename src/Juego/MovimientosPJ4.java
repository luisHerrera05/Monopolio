...
public class MovimientosPJ4 extends Thread {
    // Variables de la clase
    private JLabel FigFicha;
    private JLabel SigTurno;
    private JLabel nombreTurno;
    private JButton botongirar4;
    private int dinero;
     public int restante;
    public int cero;
    // Constructor para los Movimientos
    public MovimientosPJ4(JLabel FigFicha, JLabel SigTurno, JButton botongirar, JLabel nombreTurno) {
        this.FigFicha = FigFicha;
        this.SigTurno = SigTurno;
        this.botongirar4 = botongirar;
    ...
    public void run() {
        ...
        if (cantidad > 0) {
            ...
            if (restantetotal<=0){
         JOptionPane.showMessageDialog(null ,"ha perdido el jugador 4 " );
         }else{}
        }
    }
