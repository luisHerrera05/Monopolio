...
public class MovimientosPJ3 extends Thread {
    // Variables de la clase
    private JLabel FigFicha;
    private JLabel SigTurno;
    private JLabel nombreTurno;
    private JButton botongirar3;
    private int dinero;
     public int restante;
    public int cero;
    // Constructor para los Movimientos
    public MovimientosPJ3(JLabel FigFicha, JLabel SigTurno, JButton botongirar, JLabel nombreTurno) {
        this.FigFicha = FigFicha;
        this.SigTurno = SigTurno;
        this.botongirar3 = botongirar;
    ...
    public void run() {
        ...
        if (cantidad > 0) {
            ...
            if (restantetotal<=0){
         JOptionPane.showMessageDialog(null ,"ha perdido el jugador 3 " );
         }else{}
        }
    }
